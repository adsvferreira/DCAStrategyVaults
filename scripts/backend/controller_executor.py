...
class ControllerExecutor:
    ...
    def trigger_strategy_action(self, vault_address:str, depositor_address:str):
        controller_contract.triggerStrategyAction(worker_address, vault_address, depositor_address, {'from': BACKEND_BOT_WALLET})