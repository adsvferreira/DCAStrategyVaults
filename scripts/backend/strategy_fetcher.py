...
class StrategyFetcher:
    ...
    def fetch_vaults(self, vault_addresses:List[str], buy_frequency_timestamp:Union[int,None] = None) -> List[StrategyVault]:
    ...
    def __get_token_addresses_to_buy(self, vault_contract:AutomatedVaultERC4626, token_addresses_to_buy_length:int)->List[str]:
        return [vault_contract.buyAssetAddresses(i) for i in range(token_addresses_to_buy_length)]

    def __get_token_addresses_to_buy_decimals(self, vault_contract:AutomatedVaultERC4626, token_addresses_to_buy_length:int)->List[int]:
